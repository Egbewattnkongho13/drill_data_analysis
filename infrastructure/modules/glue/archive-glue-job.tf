...
resource "aws_s3_object" "glue_job_wheel" {
  ...
  source = "${path.module}/../../../../glue/dist/${data.local_file.wheel_filename.content}"
  etag   = filemd5("${path.module}/../../../../glue/dist/${data.local_file.wheel_filename.content}")
